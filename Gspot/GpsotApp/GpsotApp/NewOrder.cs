...
namespace GpsotApp
{
    public partial class NewOrder : Form
    {
        ...
        //DateTime mydate2 = DateTime.Now;//create date
        ...
        private void NewOrder_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // TODO: This line of code loads data into the 'evotsis_gspotDataSet7.AdditionalWorks' table. You can move, or remove it, as needed.
                this.additionalWorksTableAdapter.Fill(this.evotsis_gspotDataSet7.AdditionalWorks);
                // TODO: This line of code loads data into the 'evotsis_gspotDataSet6.PrintType' table. You can move, or remove it, as needed.
                this.printTypeTableAdapter.Fill(this.evotsis_gspotDataSet6.PrintType);
                // TODO: This line of code loads data into the 'evotsis_gspotDataSet5.PrintSize' table. You can move, or remove it, as needed.
                this.printSizeTableAdapter.Fill(this.evotsis_gspotDataSet5.PrintSize);
                // TODO: This line of code loads data into the 'evotsis_gspotDataSet4.Materials' table. You can move, or remove it, as needed.
                // TODO: This line of code loads data into the 'evotsis_gspotDataSet30.Ylika7' table. You can move, or remove it, as needed.
                this.ylika7TableAdapter.Fill(this.evotsis_gspotDataSet30.Ylika7);
                // TODO: This line of code loads data into the 'evotsis_gspotDataSet3.Work' table. You can move, or remove it, as needed.
                this.workTableAdapter.Fill(this.evotsis_gspotDataSet3.Work);
            }

            catch (Exception)
            {
                MessageBox.Show("Cannot connect to databases InvoiceData1");
            }
            ...
            {
                Fillcombo2();
                //textBox1.Text = " " + mydate2.Day.ToString() + "/" + mydate2.Month.ToString() + "/" + mydate2.Year.ToString();

            }
            catch (Exception)
            {
                MessageBox.Show("Το σύστημα δεν μπορεί να συνδεθεί στη βάση δεδομένων");
            }
        }
...
///prevent comma key press on datagridview

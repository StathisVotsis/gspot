...
namespace GpsotApp
{
    public partial class ListaErgasiwn : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'evotsis_gspotDataSet10.StagesOfOrder' table. You can move, or remove it, as needed.
            this.stagesOfOrderTableAdapter.Fill(this.evotsis_gspotDataSet10.StagesOfOrder);
            try
            {
                Fillcombo1();
            }
